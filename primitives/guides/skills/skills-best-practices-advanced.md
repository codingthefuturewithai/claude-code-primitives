# Skills: Advanced Best Practices
...
⚠️ **WARNING**: The description is injected into the system prompt, and inconsistent point-of-view can cause discovery problems.
...
## Comprehensive Checklist for Effective Skills
...
- [ ] Name uses gerund form (verb + -ing) or consistent alternative
...
- [ ] Checklist patterns included for complex workflows
...
- [ ] Utility scripts provided where appropriate
...
- [ ] Observed how Claude actually navigates the Skill

### Degrees of Freedom
- [ ] Appropriate level of specificity for task fragility
- [ ] High freedom for multi-approach tasks
- [ ] Low freedom for error-prone operations
- [ ] Clear guidance on decision points
...
- Develop iteratively with Claude A/B pattern
- Progressive disclosure keeps token usage low
- Scripts should solve, not punt to Claude
