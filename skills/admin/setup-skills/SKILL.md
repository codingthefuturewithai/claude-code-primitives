---
name: devflow:admin:setup-skills
description: Create symlinks for devflow skills. Run once after installing the plugin to enable skills.
argument-hint: ""
