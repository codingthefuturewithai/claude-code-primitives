---
name: devflow:pm:backlog
description: Manage JIRA backlog from Confluence roadmap - sync candidates, create issues, assign sprints. Use this to manage the JIRA backlog based on Confluence planning.
