---
name: devflow:docs:documentation-audit
description: Audit and update project documentation against actual source code. Use this to verify documentation is up-to-date with the codebase.
