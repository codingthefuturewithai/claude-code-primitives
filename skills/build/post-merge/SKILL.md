---
name: devflow:build:post-merge
description: Sync with remote after PR/MR merge and clean up. Use this after your pull request or merge request has been merged to clean up branches and sync.
argument-hint: ""
...
Get the merged PR/MR and any other updates:
...
```bash
/devflow:build:fetch-issue [NEW-ISSUE-ID]
```
