---
name: devflow:build:create-issue
description: Create issue with codebase analysis. Use this when the user wants to create a new issue, file a bug, or add a feature request to Jira, GitLab, or GitHub.
...
**Reference docs:** See `references/FEATURE-EXAMPLE.md`, `references/BUG-EXAMPLE.md`, `references/REFERENCE.md`
...
**🎯 CRITICAL - See references/REFERENCE.md § "Outcomes vs Implementation"**
...
**Always:**
- Reference examples (see references/ directory)
- Wait for responses at each step
- Focus on outcomes, not implementation

## References

For issue formatting standards, see:
- [references/REFERENCE.md](references/REFERENCE.md) - Standards and best practices
- [references/FEATURE-EXAMPLE.md](references/FEATURE-EXAMPLE.md) - Feature request template
- [references/BUG-EXAMPLE.md](references/BUG-EXAMPLE.md) - Bug report template
