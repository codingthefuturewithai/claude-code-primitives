...
**Multi-Backend Support:** DevFlow works with Jira or GitLab Issues, Confluence or Google Docs, and GitHub PRs or GitLab MRs.
...
| Documentation | Confluence, Google Docs, RAG Memory |
| VCS | GitHub (PRs), GitLab (MRs) |

Run `/devflow:admin:setup` to configure your backends.
