...
allowed-tools: [
  ...
  "mcp__gitlab__get_issue", "mcp__gitlab__update_issue"
]
---
...
## Step 0: Load Backend Configuration & Plan
...
**Before creating your PR/MR, consider running a security analysis:**
...
- Create pull request/merge request with all commits
- Update issue status to "Done"
- Link PR/MR to issue

**DO NOT CONTINUE** - User must run `/devflow:build:complete-issue $ARGUMENTS` to finalize
